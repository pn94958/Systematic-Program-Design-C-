...
// Char Monkey -> Monkey
// Moves the monkey back to the start if 'a' is given
...
int main()
{
    ...
    //CheckExpect3(KeyHandler(' ', 4), 0);
    //CheckExpect3(KeyHandler('a', 4), 4);
    
    cout << "Watch the monkey move left to right after pressing a letter and then enter! Letter 'a' resets the monkey." << endl;
    while(mk < 6)
    {
